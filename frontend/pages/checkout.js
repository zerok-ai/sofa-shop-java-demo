                  ...
                  <div className="border-b py-10" key={index}>
                    <div className="flex items-center">
                      ...
                      <div className="flex flex-1 justify-end">
                        ...
                        {DENOMINATION + item.price} x {item.quantity}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              */}
              ...
              <div className="md:pt-20">
                ...
                <button
                  ...
                  disabled={!stripe}
                  onClick={handleSubmit}
                  className="hidden md:block bg-black hover:bg-primary text-white font-bold py-2 px-4 mt-4 ml-4 rounded focus:outline-none focus:shadow-outline"
                >
                  Confirm order
                </button>
              </div>
